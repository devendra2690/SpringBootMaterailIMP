package com.devendrabrains.EventMgr.dto;
...
@JsonPropertyOrder({"EventDate", "ApiName", "RequestId",
        ...
        "RequestParameters", "ResponseStatus", "ResponseBody", "ResponseHeaders", "ResponseTimeInMilliSec", "ServletPath", "RemoteAddress", "RemoteHost", "RemotePort"})
